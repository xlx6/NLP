...
def get_data(tokenizer):
    ...
    train, val = train_test_split(train[:16], test_size=0.2, random_state=42)
    test = test
...
if __name__ == '__main__':
    ...
    tokenizer = DebertaV2Tokenizer.from_pretrained('C:\\Users\\Burning\\Desktop\\temp\\deberta_base\\checkpoint-1875')
    model = DebertaScratch.from_pretrained('C:\\Users\\Burning\\Desktop\\temp\\deberta_base\\checkpoint-1875')
    ...
    # wandb.init(project="contrastic_learning", name='deberta_v3_base')
