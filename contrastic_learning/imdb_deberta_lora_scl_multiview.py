...
if __name__ == '__main__':
    ...
    name="deberta_v3_base_lora_scl_multiview",  
    dir="./lora_scl_multiview"
    )
    ...
    save_path='./results/cls_lora_hidden2.csv',
    ...
    result_output.to_csv("./results/deberta_lora_multiview.csv", index=False, quoting=3)